...
class TrainClassifier:
    def __init__(self, config_file_data):
        ...
        if self.cfg.train_args.wandb:
            ...
            entity="aiotlab",
            group="SL",
            name=f"{config_file_data['dataset']['name']}_{config_file_data['model']['architecture']}",
        ...
        self.all_logs_dir = all_logs_dir
        print("All logs dir: ",all_logs_dir)
    ...
    def train(self, **kwargs):
        ...
        for epoch in range(start_epoch, self.cfg.train_args.num_epochs+1):
            ...
            if (epoch % self.cfg.train_args.print_every == 0) or (epoch == self.cfg.train_args.num_epochs) or (epoch == 0):
                ...
                if ("trn_loss" in print_args) or ("trn_acc" in print_args):
                    ...
                    with torch.no_grad():
                        ...
                        saved_dict['trn_loss'].append(trn_loss)
                    if "trn_acc" in print_args:
                        trn_acc.append(trn_correct / trn_total)
                        logger_dict['trn_acc'] = trn_correct / trn_total
                        saved_dict['trn_acc'].append(trn_correct / trn_total)
                if ("val_loss" in print_args) or ("val_acc" in print_args):
                    ...
                    with torch.no_grad():
                        ...
                        saved_dict['val_loss'].append(val_loss)
                    if "val_acc" in print_args:
                        val_acc.append(val_correct / val_total)
                        logger_dict['val_acc'] = val_correct / val_total
                        saved_dict['val_acc'].append(val_correct / val_total)
                if ("tst_loss" in print_args) or ("tst_acc" in print_args):
                    ...
                    with torch.no_grad():
                        ...
                        saved_dict['tst_loss'].append(tst_loss)
                    ...
                    if "tst_acc" in print_args:
                        ...
                        saved_dict['tst_acc'].append(tst_correct / tst_total)
                        saved_dict['best_acc'] = curr_best_acc
            ...
            logger_dict["Epoch_time"] = epoch_time
            saved_dict['epoch_time'].append(epoch_time)
        ...
        #breakpoint()
        with open(f"{self.all_logs_dir}/result.json", "w") as f:
            import json
