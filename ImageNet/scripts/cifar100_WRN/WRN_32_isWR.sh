...
LOG_DIR="./logs/${DATASET}_WRN/global_is/G${NUM_PROCS}_F${FRACTION}_E${EPOCH}_I${JOB_ID}_isWR/"
...
mpirun ${MPIOPTS} python3 ./pytorch_cifar100_WRN-28-10_is_wR.py --dataroot ${DATA_ROOT} --log-dir ${LOG_DIR} --epochs ${EPOCH} --dataset ${DATASET} --base-lr ${LR} --fraction ${FRACTION} #--seed ${SEED}
