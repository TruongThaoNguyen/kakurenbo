...
LOG_DIR="./logs/${DATASET}_WRN/global_hs_lag/G${NUM_PROCS}_F${FRACTION}_E${EPOCH}_I${JOB_ID}_v3.1/"
...
mpirun ${MPIOPTS} python3 ./pytorch_cifar100_WRN-28-10_hs_lag_v3.1.py --dataroot ${DATA_ROOT} --log-dir ${LOG_DIR} --epochs ${EPOCH} --dataset ${DATASET} --base-lr ${LR} --fraction ${FRACTION} #--seed ${SEED}
