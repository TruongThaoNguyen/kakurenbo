...
from .dataset import ImageDatasetX
...
def create_datasetX(name, root, split='validation', search_split=True, is_training=False, batch_size=None, **kwargs):
    name = name.lower()
    if name.startswith('tfds'):
        ...
        ds = ImageDatasetX(root, parser=name, **kwargs)
    return ds

### Custom dataset that return the indices of samples    
