...
def main():
    ...
    try:
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            train_metrics, samples_impt, num_updates = train_one_epoch(
                epoch, model, loader_train, optimizer, train_loss_fn, args,
                lr_scheduler=lr_scheduler, saver=saver, output_dir=output_dir,
                amp_autocast=amp_autocast, loss_scaler=loss_scaler, mixup_fn=mixup_fn,log_dir=args.log_dir, 
                samples_impt=samples_impt,loader_fw=loader_fw,num_updates=num_updates)
...
def select_samples(samples_impt,beta,seed):
...
def train_one_epoch(
        ...
        samples_impt=None, loader_fw=None, num_updates=0):
    ...
    ## CUT-OFF 
    is_samppling = select_samples(samples_impt, args.beta, args.seed + epoch)
    stop = time.time()
    ...
    return OrderedDict([('loss', losses_m.avg)]), samples_impt, num_updates
